...
// TODO(phase-3): replace with the real Vigo home screen.
  ...
  return (
    <Screen scroll>
      <View className="gap-1">
        <Text className="text-3xl font-bold text-brand">Vigo</Text>
      ...
      />
      <Button title="Sign out" variant="secondary" size="md" onPress={() => void signOut()} />
    </Screen>
  );
}
